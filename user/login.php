        ...
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              ...
              <p>Register yourself and your would be better half. Get validated by the leading marriage registrars and get started with your happy married journey.And all these, hassle free.</p>
...
<div class="form-group mg-b-0" style="padding-top: 0px"><a href="forgot-password.php">Reset password</a></div>
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Copyright &copy; 2023. Online Marriage Registration System</p>
      </div><!-- signin-box -->
